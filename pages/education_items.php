<div class="items-grid">
    ...
    <a href="school.php" class="item-card">
  ...
  <a href="college.php" class="item-card">
    <img src="../img/icons/college2.png">
    <p>কলেজ</p>
  </a>
  
  <a href="madrasha.php" class="item-card">
    <img src="../img/icons/madrasaha.png">
    <p>মাদ্রাসা</p>
  </a>
  
  <a href="cosingcenter.php" class="item-card">
    <img src="../img/icons/coachingcenter.png">
    <p>কোচিং সেন্টার</p>
  </a>
  
  
  <a href="research.php" class="item-card">
